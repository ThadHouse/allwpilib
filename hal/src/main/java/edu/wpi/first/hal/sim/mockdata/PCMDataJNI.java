...
public class PCMDataJNI extends JNIWrapper {
  ...
  public static native void setInitialized(int index, boolean solenoidInitialized);
  ...
  public static native int getAllSolenoidOutputs(int index);
  public static native void setAllSolenoidOutputs(int index, int values);
