...
Java_edu_wpi_first_wpilibj_hal_SolenoidJNI_initializeSolenoidPort(JNIEnv* env,
                                                                  jclass,
                                                                  jint id) {
...
Java_edu_wpi_first_wpilibj_hal_SolenoidJNI_checkSolenoidChannel(JNIEnv* env,
                                                                jclass,
                                                                jint channel) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_SolenoidJNI_checkSolenoidModule(JNIEnv* env,
                                                               jclass,
                                                               jint module) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_SolenoidJNI_getAllSolenoids(JNIEnv* env, jclass,
                                                           jint module) {
  int32_t status = 0;
