...
/*
 * Class:
 * edu_wpi_first_wpilibj_hal_SPIJNI_spiReadAutoReceivedData__ILjava_nio_ByteBuffer
 * Method:    2ID
 ...
 */
/*
 * Class:     edu_wpi_first_wpilibj_hal_SPIJNI_spiReadAutoReceivedData__I
 * Method:    3BID
 * Signature: (I?ID)I
 */
/*
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_SPIJNI_spiGetAutoDroppedCount(JNIEnv* env,
                                                             jclass,
                                                             jint port) {
