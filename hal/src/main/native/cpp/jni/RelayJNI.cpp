...
Java_edu_wpi_first_wpilibj_hal_RelayJNI_initializeRelayPort(JNIEnv* env, jclass,
                                                            jint id,
                                                            jboolean fwd) {
  ...
  HAL_RelayHandle handle =
      HAL_InitializeRelayPort((HAL_PortHandle)id, (uint8_t)fwd, &status);
...
Java_edu_wpi_first_wpilibj_hal_RelayJNI_checkRelayChannel(JNIEnv* env, jclass,
                                                          jint channel) {
