...
#ifndef ALLWPILIB_HAL_SRC_MAIN_NATIVE_INCLUDE_LLVM_MAPVECTOR_H_
#define ALLWPILIB_HAL_SRC_MAIN_NATIVE_INCLUDE_LLVM_MAPVECTOR_H_
...
#endif  // ALLWPILIB_HAL_SRC_MAIN_NATIVE_INCLUDE_LLVM_MAPVECTOR_H_
