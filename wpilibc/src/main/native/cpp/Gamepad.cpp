...
bool Gamepad::GetSouthButton() const {
  return GetRawButton(Button::kSouth);
}

bool Gamepad::GetSouthButtonPressed() {
  return GetRawButtonPressed(Button::kSouth);
}

bool Gamepad::GetSouthButtonReleased() {
  return GetRawButtonReleased(Button::kSouth);
}

BooleanEvent Gamepad::South(EventLoop* loop) const {
  return BooleanEvent(loop, [this]() { return this->GetSouthButton(); });
}

bool Gamepad::GetEastButton() const {
  return GetRawButton(Button::kEast);
}

bool Gamepad::GetEastButtonPressed() {
  return GetRawButtonPressed(Button::kEast);
}

bool Gamepad::GetEastButtonReleased() {
  return GetRawButtonReleased(Button::kEast);
}

BooleanEvent Gamepad::East(EventLoop* loop) const {
  return BooleanEvent(loop, [this]() { return this->GetEastButton(); });
}

bool Gamepad::GetWestButton() const {
  return GetRawButton(Button::kWest);
}

bool Gamepad::GetWestButtonPressed() {
  return GetRawButtonPressed(Button::kWest);
}

bool Gamepad::GetWestButtonReleased() {
  return GetRawButtonReleased(Button::kWest);
}

BooleanEvent Gamepad::West(EventLoop* loop) const {
  return BooleanEvent(loop, [this]() { return this->GetWestButton(); });
}

bool Gamepad::GetNorthButton() const {
  return GetRawButton(Button::kNorth);
}

bool Gamepad::GetNorthButtonPressed() {
  return GetRawButtonPressed(Button::kNorth);
}

bool Gamepad::GetNorthButtonReleased() {
  return GetRawButtonReleased(Button::kNorth);
}

BooleanEvent Gamepad::North(EventLoop* loop) const {
  return BooleanEvent(loop, [this]() { return this->GetNorthButton(); });
}
...
void Gamepad::InitSendable(wpi::SendableBuilder& builder) {
  ...
  builder.AddBooleanProperty("South", [this] { return GetSouthButton(); }, nullptr);
  builder.AddBooleanProperty("East", [this] { return GetEastButton(); }, nullptr);
  builder.AddBooleanProperty("West", [this] { return GetWestButton(); }, nullptr);
  builder.AddBooleanProperty("North", [this] { return GetNorthButton(); }, nullptr);
