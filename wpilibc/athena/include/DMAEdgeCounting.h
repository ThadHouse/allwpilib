...
class DMAEdgeCounter : public DMASampleHandlerInterface {
 public:
  DMAEdgeCounter(DMAEdgeCounter&) = delete;
  void operator=(DMAEdgeCounter) = delete;
...
class DMADigitalReader : public DMASampleHandlerInterface {
 public:
  DMADigitalReader(DMADigitalReader&) = delete;
  void operator=(DMADigitalReader) = delete;

  explicit DMADigitalReader(DigitalInput* input) : input_(input) {}
...
class DMAAnalogReader : public DMASampleHandlerInterface {
 public:
  DMAAnalogReader(DMAAnalogReader&) = delete;
  void operator=(DMAAnalogReader) = delete;

  explicit DMAAnalogReader(AnalogInput* input) : input_(input) {}
...
class DMASynchronizer {
 public:
  DMASynchronizer(DMASynchronizer&) = delete;
  void operator=(DMASynchronizer) = delete;

  explicit DMASynchronizer(::std::unique_ptr<DMA> dma)
      : dma_(::std::move(dma)) {}
